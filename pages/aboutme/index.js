...
const AboutMePage = () => {
	...
	return (
		<>
			<div className={'background-color-page div-AboutMePage-paddingPage'}>
				<div className={'align-page'}>
					<div className={'row g-0'}>
						<div className={'col-md-4'}>
							<div
								className={'div-AboutMePage-left div-AboutMePage-paddingText'}>
								<div>
									...
									<ul className={'ul-AboutMePage-style'}>
										...
										<li>
											<p className={'p-AboutMePage-text'}>
												...
												, <span className={'span-AboutMePage-text'}> Go</span>{' '}
												and{' '}
												<span className={'span-AboutMePage-text'}>
													{' '}
													Microservices
						...
						<div className={'col-md-6 div-AboutMePage-image'}>
							<div className={'div-AboutMePage-right'}>
								<Image
									src={'/aboutme.png'}
									width={524}
									height={524}
			...
			<style jsx>
				{`
					...
					.div-AboutMePage-image {
						padding-top: 100px;
					}

					.div-AboutMePage-paddingText {
						padding-top: 200px;
					}

					.div-AboutMePage-right {
						display: flex;
						justify-content: right;
						align-items: center;
					}

					.div-AboutMePage-left {
						display: flex;
						justify-content: right;
						align-items: center;
					}

					.div-AboutMePage-paddingPage {
